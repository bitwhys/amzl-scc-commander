...
const inputStyles = tv({
  base: [
    // base
    "relative block w-full appearance-none rounded-full border px-2.5 py-2 outline-hidden transition sm:text-sm",
    // border color
    "border-gray-7",
    // text color
    "text-foreground",
    ...
    "bg-white",
    // disabled
    "disabled:border-gray-8 disabled:bg-gray-8 disabled:text-gray-9",
    // file
    [
